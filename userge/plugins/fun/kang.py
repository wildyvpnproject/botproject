...
async def kang_(message: Message):
    ...
    if replied and replied.media:
        ...
        await message.edit("`Saya Tidak Bisa Colong Stickernya maaf awkowakowako...`")
        return
    if photo:
...
KANGING_STR = (
    "Menggunakan WItcher Untuk Colong...",
    "Sedang Di Plagarasi Sabar awokwkokoawkowakow...",
    "Memasukan Sticker Colongan Ke Pack...",
    "Mencolong Sticker Aaokwakowakowa...",
    "Waoo Sticker Anda Bagus Izin Colong ya!..",
    "Seru Colong Sticker Aawkowako\nhehe.",
    "Minta Izin Colong Sticker Mu : WILDYVPN...",
    "Keren Sticker Mu Izin aku Colong Awokawkokoaw",
    "Import Sticker Sabar wkoakwokoaw...",
    "Sticker Mu Sedang Di Colong... ")
